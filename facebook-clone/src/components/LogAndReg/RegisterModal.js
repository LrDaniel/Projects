      ...
      .then((auth) => {
        if (auth.user) {
          updateProfile(auth.user, {
            ...
            photoURL:
              "https://i.pinimg.com/564x/03/a9/17/03a9173e6a2ccdf3969929675ea62941.jpg",
            coverPhoto:
              "https://www.htmlcsscolor.com/preview/gallery/F0F2F5.png",
          }).then(() => {
        ...
        <div class="modal-content">
          ...
          <form>
            ...
            <div className="gender">
              <div className="gender-f" onClick={handleRef}>
